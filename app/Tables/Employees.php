...
class Employees extends AbstractTable
{
    ...
    public function for()
    {
        ...
        return QueryBuilder::for(Employee::class)
            ->defaultSort('id')
            ->allowedSorts(['id', 'first_name', 'middle_name', 'last_name'])
            ->allowedFilters(['id', 'first_name', 'middle_name', 'last_name', 'department_id', 'country_id', 'state_id', 'city_id', $globalSearch]);
    }
